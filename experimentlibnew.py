...
import dy_import_module

import fastnmclient
repytime = dy_import_module.import_repy_module("time")
rsa = dy_import_module.import_repy_module("rsa")
parallelize = dy_import_module.import_repy_module("parallelize")
advertise = dy_import_module.import_repy_module("advertise")
